...
Console.WriteLine("Приветствую, пользователь! Данная программа выводит в терминал все четные значения в диапазоне от 1 до N");
...
while (count <= number)
{
    ...
    count += 2; // Увеличиваем счетчик на 2, пропуская нечетные значения. 
}
